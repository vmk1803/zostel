...
<div>
  <section className='section1'>
    <h2>COVID Policy</h2>
    <p>
    - For intra-state travelers - At the time of check-in, all guests travelling from within the same state are required
     to present either a negative RT-PCR report not older than 72 hours, or a double-vaccination certificate.
    </p>
    <p>
    - For inter-state travelers - At the time of check-in, all guests travelling from another state are required to present
     a negative RT-PCR report not older than 72 hours, or a vaccination certificate (either single or double dose).
    </p>
    <p>
    - Please ensure you have read the health and travel advisory issued by your destination state.
    </p>
    <p>
    - Well-equipped first-aid and Covid-19 observation kits are available at this hostel in case of a medical emergency.
    </p>
    <p>
    ...
    <p>
    - This hostel is equipped with a sanitisation counter where travellers can disinfect any outside materials such as parcels, bags, etc.
    </p>
    <p>
    - For long-stay residents, a meal package is available at INR 500, covering three meals per day.
    </p>
  </section>
  <section  className='section2'>
    <h2>Property Policy</h2>
      ...
      <p>
        - We strictly DO NOT allow a group of more than 8 people. In case of a group of 4 or more, you might be purposefully allotted
          different dorm rooms. Further, if the group behaviour is deemed unfit at the property, the Zostel Property Manager, upon subjective
          evaluation, retains the full right to take required action which may also result in an on-spot cancellation without refunds.
      </p>
      <p>
  ...
  <section className='section3'>
    ...
    <p>
- If you have paid any amount over this 21%, it stands applicable for a credit only if the cancellation is informed 7 days or more
 in advance. You will be able to avail the credited amount for any future booking at any of our properties.
    </p>
    <p>
