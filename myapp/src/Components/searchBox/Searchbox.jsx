...
export const Searchbox = () => {
    ...
    const [scndtoggle , setSCNDTOGGLE] = useState(false)
    const scndtogglebtn = () =>setSCNDTOGGLE(!scndtoggle);

    return (
        <>
            <div className="background">
                <div className="option1">
                 <button style={{backgroundColor: scndtoggle ? 'rgb(35,22,17)' : '#F1563F'}} onClick={scndtogglebtn}>
                     ZOSTAL
                 </button>
                </div>
                <div className="option2">
                   <button className='btnmnmn'  style={{backgroundColor: toggle ? 'rgb(35,22,17)' : '#F1563F'}} onClick={toggleButton} >Zostel Homes</button>
